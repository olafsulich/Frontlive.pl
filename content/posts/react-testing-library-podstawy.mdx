...
Konfigurację Jest zamieścimy w pliku `jest.config.js` w katalogu głównym projektu. To, co nas tutaj najbardziej interesuję to podanie ścieżki to pliku `setupTests.ts`, do którego za chwilę wrócimy.
