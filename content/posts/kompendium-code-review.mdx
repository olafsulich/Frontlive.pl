...
Jednym z [głównych celów](https://frontlive.pl/blog/kompendium-code-review/#wprowadzenie) Code Review jest lepsze zrozumienie systemu, w którym pracujemy. Jeśli oceniając kod, nie rozumiesz jego przeznaczenia, tracisz jeden z benefitów.
