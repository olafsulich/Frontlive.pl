...
Co prawda te staystyki dostarczył mi pewien [znany instytut](https://www.facebook.com/InstytutBadanZDupy/), ale opieram się bardziej na własnych doświadczeniach.
...
3. **JavaScript**
   ...
   Trzeba na pewno przynaznać mu jedno - kompletnie zawładnął światem i jest aktualnie jednym z najpopularniejszych języków programowania na świecie. Nie jest idealny, ale nic takie nie jest.
...
2. **Brak kontroli nad środowiskiem**
   ...
   Ponownie, problem może wydawać się wyolbrzymiony. Naukę o responsywności zaczynamy w początkowych etapach. Dostosowanie strony pod różne rozdzielczności to standard, nic nadzwyczajnego.

   Sęk w najróżniejszych przeglądarkach i ich wersjach. Nie zliczę godzin jakie poświęciłem na naprawianie i debugowanie błędów na Safari. Nie wspominam już o Frontend Developerach, którzy mają _przyjemność_ wspierać stare wersje Internet Explorer - tak, takie systemy nadal istnieją i są utrzymymane.
...
4. **Performance**
   ...
   Świat pędzi w zawrotnym tempie. Chcemy wszystko na teraz, natychmiast. Media społecznościowe dostarczają nam tysiące różnych bodźctów każdego dnia. Chcą przyciągnąć i zachować naszą uwagę.
...
6. **Dobre praktyki, skalowanie software'u, testy**
   ...
   Oczywiście, istnieje szereg wzorców, dobrych praktyki i zasad, które są uniwersalne - niezależnie nad jakim kodem pracujemy.
   ...
   Prowadzić to może do sytuacji, w których piszemy słabo skalujący się kod, wykorzystując utarte schematy z innych dziedziń programowania. Z drugiej strony, często szukamy _tego właściwego_ rozwiązania, niekiedy wynajdując koło na nowo.
