...
<Image src="/images/design-tokens/tokens.png" alt="" />

Tokenem mogą być rodzaje/wielkości/grubości fontów i zaokrągleń, warianty cieni i przezroczystości, odstępy pomiędzy elementami... Ogranicza nas tak jedynie przyjęte podejście i narzędzia, z których korzystamy.
...
<Image src="/images/design-tokens/tokens-names-global.png" alt="" />
...
Wyobraź sobie sytuację, w której Designer tworzy te wszysktie odcienie kolorów i nakłada na elementy. Pewnego dnia stwierdza, że wywraca do góry nogami tło strony i ma być ono teraz czerwone, a nie fioletowe. Ałć, mamy problem. Przecież nie zmienimy nagle koloru w `color-purple-100` na krwistą czerwień...
...
<Image src="/images/design-tokens/tokens-names-domain.png" alt="" />
...
<Image src="/images/design-tokens/tokens-names-domain-2.png" alt="" />
...
Figma jest super, ale w tym przypadku jej możliwości są bardzo ogranizone. Natywnie, pozwala tylko na tokeny dla kolorów i fontów.
...
<Image src="/images/design-tokens/tokens-studio-1.png" alt="" />

## Synchronizacja z kodem

Przechodzimy do mięska. Największych plusem Tokens Studio jest możliwość wyeksportowania tokenów z Figmy do zewnętrznej usługi. To, co nas będzie interesowało, to _export_ bezpośrednio do repozytorium na GitHubie.

_Hmm, ale właściwie po co mielibyśmy to robić?_

Wyobraź sobie, że pracujesz nad produktem, który dostępny jest w wersji webowej i mobilnej. Technologicznie, każda platforma jest niezależna. Wasze komponenty mogą co prawda się nieco od siebie różnić, ale na koniec dnia korzystacie z tego samo Design Systemu.
...
<Image src="/images/design-tokens/sync-clients.png" alt="" />
...
<Image src="/images/design-tokens/tools.png" alt="" />
...
<Image src="/images/design-tokens/tokens-studio-2.png" alt="" />
...
<Image src="/images/design-tokens/tokens-studio-github.png" alt="" />
...
Do pomyślej transformacji (już kolejnej!), będziemy potrzebować pliku konfiguracyjnego, w którym wskazujemy `source` (_input_), `destination` (_output_) oraz format, do którego tokeny będą transformowane:
...
<Image src="/images/design-tokens/github-action.png" alt="" />

Zamiast tego, tworzymy sobie [GitHub Action](https://github.com/features/actions), które będzie robiło całą robotę za nas:
...
Design nie jest taki straszny, jak może się na początku wydawać. Poznanie podstaw tworzenia strony, aplikacji i Design Systemów jest bardzo pomocne w naszej codziennej pracy Frontend Developera.
