...
excerpt: 'React, JSX i renderowanie warunkowe - to nie może się skończyć dobrze! Sprawdź jakie pułapki czyhają na nas podczas korzystania z operatorów logicznych (i nie tylko)'
---
...
Wszystko rozchodzi się o tzw. [pierwszeństwo operatorów](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator_Precedence). Logiczny operator OR (`||`) ma pierwszeństwo nad AND ('&&'), dlatego pod spodem nasz kodem będzie wyglądał w ten sposób:
