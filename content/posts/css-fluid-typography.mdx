...
![](/images/articlesImages/min-fn-1.png)
...
![](/images/articlesImages/min-fn-2.png)
...
![](/images/articlesImages/max-fn-1.png)
...
![](/images/articlesImages/max-fn-2.png)
...
![](/images/articlesImages/clamp-fn-1.png)
...
<Player url="/images/articlesImages/fluid-1.mp4" label="" />
...
![](/images/articlesImages/clamp-paragraph.png)
...
![](/images/articlesImages/clamp-margin.png)
...
![Tabela wyników wsparcia przez przeglądarki dla funkcji clamp, min i max](/images/articlesImages/clamp-wsparcie.png)
