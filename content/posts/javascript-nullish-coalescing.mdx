...
isPublished: true
popular: false
image: '/images/category-javascript.png'
excerpt: 'Specyfikacja ECMAScript cały czas się rozwija, powstają nowe ciekawe featury. Jakiś czas temu, zostały zaproponowane dwa nowe: nullish coalescing i optional chaining'
---
