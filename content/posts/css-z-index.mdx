...
Wszyscy wiemy jak ustawić dwa kwadraty tak, aby jeden nachodził na drugi. Wrzucamy dwa _boxy_ do wspólnego rodzica. Dominującemy kwadratowi nadajemy większą wartość `z-index`:
...
Usuwając _stacking context_ `box-dashed` zostajemy z trzema _warstami_:
