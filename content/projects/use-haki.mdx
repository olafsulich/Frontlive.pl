...
Żarty są trzymane w [JSONBIN](https://jsonbin.io/), wpisywanie ich tam było karkołomne, ale teraz mogę się pochwalić największą bazą polskich sucharów programistycznych w formie api - well done!
